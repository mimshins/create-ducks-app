# Contributing to "CreateDucksApp"

If you're reading this, you're definitely awesome!

The following is a set of guidelines for contributing to "CreateDucksApp", which is hosted in the [GitHub](https://github.com/mimshins/create-ducks-app). These are mostly guidelines, not rules. Use your best judgment, and feel free to propose changes to this document in a pull request.

## Code of Conduct

This project and everyone participating in it is governed by the [Code of Conduct](https://github.com/mimshins/create-ducks-app/blob/main/CODE_OF_CONDUCT.md). By participating, you are expected to uphold this code.

## A large spectrum of contributions

There are many ways to contribute to "CreateDucksApp", code contribution is one aspect of it. For instance, documentation improvements are as important as code changes.
...
To help you get your feet wet and get you familiar with our contribution process, we have a list of [good first issues](https://github.com/mimshins/create-ducks-app/issues?q=is:open+is:issue+label:"good+first+issue") that contain changes that have a relatively limited scope. This label means that there is already a working solution to the issue in the discussion section. Therefore, it is a great place to get started.
...
"CreateDucksApp" is a community project, so Pull Requests are always welcome, but, before working on a large change, it is best to open an issue first to discuss it with the maintainers.
...
cd dot-helix-ui
git remote add upstream https://github.com/mimshins/create-ducks-app.git
```
...
7. Go to [the repository](https://github.com/mimshins/create-ducks-app) and make a Pull Request.
